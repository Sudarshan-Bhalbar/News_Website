...
// import img1 from "./resources/electronics_img/6.png";
        ...
        <div className="card border-0 mb-3" style={{ maxWidth: "100%" }}>
          <div className="row g-0">
            <div className="col-2 text-center my-3  ">
              <img src={img5} className="img-fluid rounded shadow  w-75 h-auto " alt="..."/>
            </div>
            <div className="col-9">
...
export default Electrical_boxes;

...
import img1 from "./resources/Medical/1.png";
    ...
    <div className="container mb-3">
      <div className="card border-0 mb-3" style={{ maxWidth: "100%" }}>
        <div className="row g-0">
          <div className="col-2 text-center mt-1 px-0">
            <img src={img1} className="img-fluid rounded text-center  w-75 h-auto " alt="..."/>
          </div>
          <div className="col-9">

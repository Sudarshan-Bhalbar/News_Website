...
export default class Mech extends Component {
  ...
  async componentDidMount() {
    let url =
      `https://newsapi.org/v2/everything?q=educational&from=2023-02-28&sortBy=publishedAt&apiKey=1ed3bcb965ee4c41b111430e84b5b370&language=en&page=1&pageSize=${this.props.pageSize}`;
  ...
  handlePreviousClick = async () => {
    let url = `https://newsapi.org/v2/everything?q=educational&from=2023-02-28&sortBy=publishedAt&apiKey=1ed3bcb965ee4c41b111430e84b5b370&language=en&page=${
      this.state.page - 1
